...
// Initialize library for subsequent pressure measurements
{
	...
	/*if (I2Cdev_readBits(BMP180_ADDR, 0xAA, 0x00, 2, &AC1) &&
		...
		I2Cdev_readBits(BMP180_ADDR, 0xB2, 0x00, 2, &AC5) &&
		I2Cdev_readBits(BMP180_ADDR, 0xB4, 0x00, 2, &AC6) &&
		I2Cdev_readBits(BMP180_ADDR, 0xB6, 0x00, 2, &VB1) &&
		I2Cdev_readBits(BMP180_ADDR, 0xB8, 0x00, 2, &VB2) &&
