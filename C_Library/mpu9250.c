					  ...
					  unsigned char const *data )
{
    ...
    I2Cdev_writeBytes((uint8_t)slave_addr, (uint8_t)reg_addr, (uint8_t)length, (uint8_t *)data);
}
					 ...
					 unsigned char *data )
{
    ...
    return I2Cdev_readBytes((uint8_t)slave_addr, (uint8_t)reg_addr, (uint8_t)length, (uint8_t *)data);
}
