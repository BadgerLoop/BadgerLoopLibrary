...
unsigned long MS_5803_ADC(char commandADC) {
    ...
    LDByteWriteI2C(MS5803_I2C_ADDRESS, CMD_ADC_CONV + commandADC, (unsigned char)0);
    //LDByteReadI2C(MS5803_I2C_ADDRESS, unsigned char Address, unsigned char *Data, unsigned char Length)
    ...
    LDByteReadI2C(MS5803_I2C_ADDRESS, CMD_ADC_READ, &I2C_Bytes, (unsigned char) 3);
...
bool MS_5803_init(bool Verbose) {
    ...
    for (int i = 0; i < 8; i++ ) {
        ...
        LDByteReadI2C(MS5803_I2C_ADDRESS, 0xA0 + (i * 2), &I2C_Bytes, (unsigned char) 2);
