...
#aws_access_key_id="AKIAJEO5EIDITWQA7GEQ"
#aws_secret_access_key="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"
        ...
        while finish > datetime.datetime.now():
            try:
                ...
                if len(response['Records']) > 0:
                    ...
                    if self.echo:
                        #echo_records(response['Records'][len(response['Records'])-1])
...
that hunt for the word "egg" in records from each shard.''',
    ...
    parser.add_argument('--region', type=str, default='us-west-2',
        help='''the name of the Kinesis region to connect with [default: us-west-2]''') 
